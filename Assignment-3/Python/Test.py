...
def run_tests(Failed_test_cases: list = []):
    assert isinstance(Failed_test_cases, list), "Failed_test_cases should be a list"
...
if __name__ == "__main__":
    ...
    if len(Failed_test_cases) == 0:
        print(f"\033[92mAll({total_test_cases}) tests passed!\033[0m")
    else:
