...
entry:
  ...
  call void @mem_insert_unchecked(ptr noundef %arraydecay, ptr noundef @.str, i32 noundef 6, i32 noundef 5), !dbg !27
...
declare void @mem_insert_unchecked(ptr noundef, ptr noundef, i32 noundef, i32 noundef) #3
