...
entry:
  call void @llvm.dbg.value(metadata i32 10, metadata !15, metadata !DIExpression()), !dbg !16
  call void @llvm.dbg.value(metadata i32 5, metadata !17, metadata !DIExpression()), !dbg !16
  %div = sdiv i32 10, 5, !dbg !18
  call void @llvm.dbg.value(metadata i32 %div, metadata !19, metadata !DIExpression()), !dbg !16
  %cmp = icmp eq i32 %div, 2, !dbg !20
  call void @svf_assert(i1 noundef zeroext %cmp), !dbg !21
  ret i32 0, !dbg !22
}
...
!1 = !DIFile(filename: "test2.c", directory: "/Users/z5489735/2023/0513/Software-Security-Analysis/Assignment-3/Tests/ae")
...
!10 = !DIFile(filename: "./test2.c", directory: "/Users/z5489735/2023/0513/Software-Security-Analysis/Assignment-3/Tests/ae")
...
!18 = !DILocation(line: 6, column: 12, scope: !9)
!19 = !DILocalVariable(name: "c", scope: !9, file: !10, line: 6, type: !13)
!20 = !DILocation(line: 7, column: 15, scope: !9)
!21 = !DILocation(line: 7, column: 2, scope: !9)
!22 = !DILocation(line: 8, column: 2, scope: !9)
